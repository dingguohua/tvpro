 ...
 */
qx.Class.define("tvproui.statistic.EPG.DimensionalitySelector",
{
  ...
  statics :
  {
    ...
    getProperMaterial : function(URL, materialData)
    {
      ...
      var cache = tvproui.statistic.EPG.DimensionalitySelector.materialCache;
     ...
     */
    clearCache : function() {
      tvproui.statistic.EPG.DimensionalitySelector.materialCache = {
  ...
  members :
  {
    ...
    createCellEditor : function(cellInfo)
    {
      ...
      tvproui.statistic.EPG.DimensionalitySelector.lastTable = cellInfo.table;
    ...
    _onListSelected : function(item)
    {
      ...
      tvproui.statistic.EPG.DimensionalitySelector.lastTable.stopEditing();
    },
    ...
    _refreshTable : function(cellEditor, value)
    {
      ...
      var rows = tvproui.statistic.EPG.DimensionalitySelector.getProperMaterial("Material/getlikeMatchMaterial",
      {
        "ID" : channelID,
        "name" : value
      });
    ...
    getCellEditorValue : function(cellEditor)
    {
      ...
      tvproui.statistic.EPG.DimensionalitySelector.lastMaterial = selected;
      tvproui.statistic.EPG.DimensionalitySelector.clearCache();
      ...
      tvproui.statistic.EPG.DimensionalitySelector.lastMaterial = material;
