 ...
 */
qx.Class.define("tvproui.control.ui.spanTable.columnmodel.Resize",
{
  extend : tvproui.control.ui.spanTable.columnmodel.Basic,
  ...
  */
  members :
  {
     ...
     * @param table {qx.ui.table.Table} The table which this model is used for. This allows us access to
     ...
     *
     * @param event {qx.event.type.Data} The "columnVisibilityMenuCreateEnd" event indicating that the menu is
     ...
     *
     * @param event {qx.event.type.Event} The "onwindowresize" event object.
     */
     ...
     *
     * @param event {qx.event.type.Data} The "verticalScrollBarChanged" event object.  The data is a boolean
     ...
     *
     * @param event {qx.event.type.Data} The "widthChanged" event object.
     */
     ...
     *
     * @param event {qx.event.type.Data} The "visibilityChanged" event object.
     */
