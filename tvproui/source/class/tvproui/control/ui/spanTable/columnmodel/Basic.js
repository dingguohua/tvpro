 ...
 */
qx.Class.define("tvproui.control.ui.spanTable.columnmodel.Basic",
{
  ...
  */
  statics :
  {
    ...
    DEFAULT_DATA_RENDERER : tvproui.control.ui.spanTable.cellrenderer.Default,
  ...
  */
  members :
  {
     ...
     * @param table {qx.ui.table.Table} The table to which this column model is attached.
     */
    init : function(colCount, table)
    {
      ...
      var dataRenderer = this.__dataRenderer || (this.__dataRenderer = new tvproui.control.ui.spanTable.columnmodel.Basic.DEFAULT_DATA_RENDERER());
     ...
     * @param isMouseAction {Boolean} <i>true</i> if the column width is being changed as a result of a
     ...
     * @return {qx.ui.table.ICellRenderer} If an old renderer was set and
     ...
     * @return {var} TODOC
     */
    getOverWriteStyle : function(col) {
      return this.__colOverWriteStyle[col];
    },
     ...
     */
    setOverWriteStyle : function(col, style) {
      this.__colOverWriteStyle[col] = style;
    },
  ...
  */
  destruct : function()
  {
    ...
    this.__overallColumnArr = this.__visibleColumnArr = this.__columnDataArr = this.__colToXPosMap = this.__colOverWriteStyle = null;
