 ...
 */
qx.Class.define("tvproui.control.ui.spanTable.cellrenderer.Conditional",
{
  ...
  */
  members :
  {
     ...
     * @throws If the condition can not be recognized or value is null.
     */
    ...
    _getCellStyle : function(cellInfo)
    {
      ...
      for (i in this.conditions)
      {
        ...
        if (qx.lang.Array.contains(this.numericAllowed, this.conditions[i][0]))
        {
          ...
          {
            case "==":if (compareValue == this.conditions[i][5]) {
              cond_test = true;
            }
            break;
            case "!=":if (compareValue != this.conditions[i][5]) {
        ...
        } else if (qx.lang.Array.contains(this.betweenAllowed, this.conditions[i][0]))
        {
          ...
          switch (this.conditions[i][0])
          {
            case "between":if (compareValue >= this.conditions[i][5] && compareValue <= this.conditions[i][6]) {
              cond_test = true;
            }
            break;
            case "!between":if (compareValue < this.conditions[i][5] || compareValue > this.conditions[i][6]) {
