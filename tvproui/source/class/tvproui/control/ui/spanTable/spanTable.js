 ...
 */
qx.Class.define("tvproui.control.ui.spanTable.spanTable",
{
  ...
  */
  ...
  construct : function(tableModel, custom)
  {
    ...
    this.setDataRowRenderer(new tvproui.control.ui.spanTable.rowrenderer.Default(this));
  ...
  */
  properties :
  {
    ...
    dataRowRenderer :
    {
      check : "tvproui.control.ui.spanTable.rowrenderer.Default",
      init : null,
      nullable : true,
    ...
    newSelectionManager :
    {
      check : "Function",
      init : function(obj) {
        return new tvproui.control.ui.spanTable.selection.Manager(obj);
      }
    },
    ...
    newSelectionModel :
    {
      check : "Function",
      init : function(obj) {
        return new tvproui.control.ui.spanTable.selection.Model(obj);
      }
    },
    ...
    newTableColumnModel :
    {
      check : "Function",
      init : function(table) {
        return new tvproui.control.ui.spanTable.columnmodel.Basic(table);
      }
    },
    ...
    newTablePane :
    {
      check : "Function",
      init : function(obj) {
        return new tvproui.control.ui.spanTable.pane.Pane(obj);
      }
    },
    ...
    newTablePaneScroller :
    {
      check : "Function",
      init : function(obj) {
        return new tvproui.control.ui.spanTable.pane.Scroller(obj);
      }
    },
  ...
  */
  members :
  {
    ...
    _createChildControlImpl : function(id, hash)
    {
      ...
      switch (id)
      {
        case "statusbar":control = new qx.ui.basic.Label();
        control.set( {
          allowGrowX : true
        });
        this._add(control);
    ...
    _onKeyPress : function(evt)
    {
      ...
      if (this.isEditing()) {
        ...
        } else
        {
          ...
          switch (identifier)
          {
            case "Space":this.__selectionManager.handleSelectKeyDown(this.__focusedRow, evt);
            break;
      ...
      if (oldFocusedRow != this.__focusedRow && this.getRowFocusChangeModifiesSelection())
      {
        ...
        var tableModel = this.getTableModel();
        var level = tableModel.getColumnLevel(this.__focusedCol);
        this.__selectionManager.handleMoveKeyDown(this.__focusedRow, level, evt);
      }
      if (consumed)
      {
        evt.preventDefault();
    ...
    setFocusedCell : function(col, row, scrollVisible)
    {
      ...
      if (!this.isEditing() && (col != this.__focusedCol || row != this.__focusedRow))
      {
        ...
        var scrollerArr = this._getPaneScrollerArr();
        for (var i = 0; i < scrollerArr.length; i++) {
          scrollerArr[i].setFocusedCell(col, row, span);
        }
     ...
     * @param listener {var} TODOC
     * @param self {var} TODOC
     * @param capture {var} TODOC
     * @return {var} TODOC
     */
