 ...
 */
qx.Class.define("tvproui.control.ui.form.ComboBox",
{
  ...
  */
  ...
  {
    this.base(arguments);
    this._selectItemCallback = callback;
  ...
  members :
  {
    ...
    */
    ...
    _createChildControlImpl : function(id, hash)
    {
      ...
      switch (id)
      {
        ...
        this._add(control);
        break;
        case "list":// Get the list from the AbstractSelectBox
    ...
    */
    ...
    _setPreselectedItem : function() {
      ...
      {
        this._selectItemCallback.call(this, this.__preSelectedItem);
