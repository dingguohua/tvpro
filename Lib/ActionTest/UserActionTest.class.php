...
{    
	...
	//begin test
	public function testgetDesktopIcon()
	{
		//preTest
		$c_url = URL_PREFIX.'User/getDesktopIcon';
		$c_url_data = "";
		...
		//verify the result
		$this->assertEquals(count($data['info']),10);
	}
	...
	{
		//preTest
		$c_url = URL_PREFIX.'User/registerUser';
		$c_url_data="username=hudsontest&alias=test&password=123456&email=test@cjltv.com&mobilephone=13770600424&status=1&imageid=1&resourceid=2";
		
		//Test action
		$data=$this->sendPostMsgToURL($c_url, $c_url_data);
		
		//verify the result
		$assertvalue=($data['info']-1)>0?true:false;
		$this->assertEquals($assertvalue,true);
	...
	{
		//preTest
		$c_url = URL_PREFIX.'User/disableUser';
		$c_url_data="username=hudsontest";
		
		//Test action
		$data=$this->sendPostMsgToURL($c_url, $c_url_data);
		
		//verify the result
		$this->assertEquals($data['info'],1);
	}
	
	public function testenableUser()
	{
		//preTest
		$c_url = URL_PREFIX.'User/enableUser';
		$c_url_data="username=hudsontest";
